...
export const cachedVersions = writable<{
  ...
  steamodded: typeof window !== "undefined" ? JSON.parse(localStorage.getItem("version-cache-steamodded") || "[]") : [],
  talisman: typeof window !== "undefined" ? JSON.parse(localStorage.getItem("version-cache-talisman") || "[]") : [],
});

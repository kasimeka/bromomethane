...
<div class="message-stack">
  {#each $messageStore as message (message.id)}
    <div class="message {message.type}" transition:fly={{y: -20, duration: 200}}>
      <div class="message-content">
        {#if message.type === "success"}
          <svg class="icon" viewBox="0 0 24 24">
            <path fill="#74CCA8" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />
          </svg>
        ...
        {:else if message.type === "warning"}
          <svg class="icon" viewBox="0 0 24 24">
            <path fill="#A39358" d="M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16" />
          </svg>
        {/if}

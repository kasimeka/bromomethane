<script lang="ts">
  ...
  const handlePathSelect = async () => {
    ...
    const selected = await open({
      ...
      multiple: false,
      title: customPathType === "directory" ? "Select Balatro Directory" : "Select Balatro Executable",
      filters: customPathType === "executable" ? [{name: "Executable", extensions: ["exe"]}] : undefined,
    });
...
<div class="page-wrapper">
  <div class="container" class:expanded={showCustomInput}>
    ...
    {#if showCustomInput}
      <div class="custom-input-section" in:fly={{duration: 200, y: 10}} out:fly={{duration: 200, y: -10}}>
        ...
        <div class="input-container">
          <input
            type="text"
            placeholder={customPathType === "directory" ? "Choose Balatro Directory" : "Choose Balatro Executable"}
            disabled={isLoading}
    ...
    <div class="button-wrapper">
      ...
      {/if}
      <button class="action-button" on:click={handleClick} disabled={isLoading}>
        {#if isLoading}

...
{#if show}
  <div class="popup-overlay" transition:fade={{duration: 100}}>
    <div class="popup-content" transition:scale={{duration: 200, start: 0.95, opacity: 1}}>
      ...
      <div class="popup-body">
        ...
        <div class="button-container">
          <button class="proceed-button" onclick={handleProceedClick}> Download Anyway </button>
          <button class="cancel-button" onclick={() => (show = false)}> Close </button>
        </div>
      </div>
    </div>
  </div>
